...
#---------------------------------------------------------------------------------
LIBS		:=	../lib/libcobra.a ../lib/libntfs_ext.a ../lib/libsfm_ps3.a ../lib/libfatfs.a -lfreetype -lz -ltiny3d -lnetctl -lnet -lsysfs -lpngdec -ljpgdec -lsimdmath -lgcm_sys -lio -lsysutil -lrt -llv2 -lsysmodule \
